...
from rest_framework import status, permissions, generics, views, exceptions
...
from {{ cookiecutter.project_slug }}.users.api.tasks import send_register_mail, send_reset_password_email
...
class RegisterUserView(RegisterView):
    ...
    def perform_create(self, serializer):
        ...
        send_register_mail.delay(user, confirmation.key)
        return user
