                    ...
                    <Row>
                        <Col lg={6}>
                            ...
                            <p className="text-muted mt-4">
                                {% raw %}{{cookiecutter.project_name}}{% endraw %} makes it easier to build better websites with
                        ...
                        <Col>
                            <div className="mt-5">
                                <p className="text-muted mt-4 text-center mb-0">
                                    © 2018 - 2021 {% raw %}{{cookiecutter.project_name}}{% endraw %}. Design and coded by Coderthemes
                                </p>
                            </div>
                        </Col>
                    </Row>
